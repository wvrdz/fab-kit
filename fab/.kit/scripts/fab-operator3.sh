...
# ---
# name: fab-operator3
# description: "Launch operator3 in a dedicated tmux tab (singleton per session)"
# ---
set -euo pipefail
...
tmux new-window -c "$REPO_ROOT" -n "$TAB_NAME" "claude --dangerously-skip-permissions '/fab-operator3'"
