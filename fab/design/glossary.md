...
| `checklists/quality.md` | Auto-generated quality checklist inside a change folder. Items derived from spec and constitution. Verified by `/fab-continue` (review); all items must pass before archive. |
| `fab/current` | Pointer file containing the active change name. Read by every skill; updated by `/fab-new`, `/fab-switch`; cleared by `/fab-continue` (archive). |
...
| **CHK-###** | Checklist item ID in `checklists/quality.md` (e.g., CHK-001). Sequential. Verified by `/fab-continue` (review). |
