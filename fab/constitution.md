...
Specifications in `fab/specs/` are human-curated, pre-implementation artifacts that capture the *planned* design. They MUST NOT be auto-generated or overwritten by tooling. Specs record the "why" and conceptual intent behind features; `fab/memory/` records what actually shipped. Agents SHOULD consult specs for design rationale and architectural context when generating change artifacts.
