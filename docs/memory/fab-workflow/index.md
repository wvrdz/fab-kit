...
| [kit-architecture](kit-architecture.md) | `src/kit/` structure (binary-free), three-binary architecture (fab router + fab-kit + fab-go), `fab-kit sync`, agent integration, versioning, monorepos, underscore file ecosystem, `fab pane` command group | 2026-04-05 |
