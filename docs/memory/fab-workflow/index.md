...
| [execution-skills](execution-skills.md) | Apply, review, hydrate, archive, and operator behavior — `/fab-continue` for pipeline stages, `/fab-archive` for housekeeping, `/fab-operator1`, `/fab-operator2`, `/fab-operator3`, and `/fab-operator4` for cross-agent coordination | 2026-03-14 |
